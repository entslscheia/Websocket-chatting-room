...
(function(){
    ...
    function st(){
        ...
        so.onmessage=function(msg){
            ...
            if(da.type=='add'){
                ...
                lus.appendChild(obj);
                cuser(obj,da.code,0);
                obj=A.$$('<p><span>['+da.time+']</span>欢迎<a class="admin'+da.isadmin+'">'+da.name+'</a>加入</p>');
                c=da.code;
            ...
            if(obj==false){
                if(da.type=='rmove'){
                    if(da.msg){
                        ...
                        var _tms = users[da.nrong].innerHTML+'退出聊天室';
                    }
                    ...
                    if(da.code1==mkey){
                        ...
                        obj=A.$$('<p><span>['+da.time+']</span><a>'+users[da.code].innerHTML+'</a>对'+users[da.code1].innerHTML+'说：<var class="admin'+da.isadmin+'">'+da.nrong+'</var></p>');
                        c=da.code;
                    }
                }
            }
    ...
    function cuser(t,code,isa){
        users[code]=t;
        if(isa){
            t.title = '双击剔除此用户!';
        }
        t.ondblclick=function(){
            so.send('nr=1&key='+code+'&out=1');
        }
        t.onclick=function(){
